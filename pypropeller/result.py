...
class PyproResult(pd.DataFrame):
    ...
    def plot_boxplot(self, 
                         clusters=None,
                         n_columns=3):
        """ Plot the proportions of each cluster in the result as box plots.
    ...
    def plot_stripplot(self, 
                         clusters=None,
                         n_columns=3):
        """Plot the proportions of each cluster in the result as strip plots.
    ...
    def plot_barplot(self, 
                         clusters=None,
                         n_columns=3):
        """Plot the proportions of each cluster in the result as bar plots.
